function Summary(){
    return(
        <section className="flex flex-row w-full items-center pt-[36px] px-[20px] md:px-0 max-w-[1280px] gap-x-[120px] text-[#0E1C29]">
            <div className="flex flex-col flex-1 max-w-[50%]">
                <div className="flex flex-col gap-y-[20px]">
                    <h1 className="dm-sans text-[36px] leading-[3rem] md:text-[44px] xl:text-[56px]">Portfoy</h1>
                    <span>Alter is a sleek Framer template built for AI-driven SaaS platforms to enhance marketing automation and customer engagement.</span>
                </div>
                <div className='flex gap-x-[15px] text-[14px] mt-[25px] px-[20px] w-full md:max-w-[340px] md:px-0 translate-x-[0px] opacity-100 heroTextTransition delay2-5s'>
            ...
            <div className="flex flex-row flex-wrap flex-1 max-w-[50%] gap-x-[20px] gap-y-[35px]">
                <div className="flex flex-col grow shrink-0 w-[40%] max-w-[50%] gap-y-[8px]">
                    <em className="font-semibold text-[14px]">Services</em>
                    <span className="max-w-[200px]">Web Design, Development, No-Code</span>
                </div>
                <div className="flex flex-col grow shrink-0 w-[40%] max-w-[50%] gap-y-[8px]">
                    <em className="font-semibold text-[14px]">Tools</em>
                    <span className="max-w-[200px]">Framer, Figma, Adobe CC</span>
                </div>
                <div className="flex flex-col grow shrink-0 w-[40%] max-w-[50%] gap-y-[8px]">
                    <em className="font-semibold text-[14px]">Value</em>
                    <span className="max-w-[200px]">Clean and premium</span>
                </div>
                <div className="flex flex-col grow shrink-0 w-[40%] max-w-[50%] gap-y-[8px]">
                    <em className="font-semibold text-[14px]">Timeline</em>
                    <span className="max-w-[200px]">1 week</span>
                </div>
            </div>
        </section>
    )
