export default function KeyPoints(){
    return(
        <section className='flex flex-col w-full min-h-[100vh] items-center py-[100px] bg-[#D8DFE5] rounded-t-[80px]'>
            ...
            <h2 className='dm-sans text-[56px] mt-[12px]'>Crafting Digital Excellence</h2>
            <span className='mt-[20px]'>Building smooth and engaging digital interactions that elevate user satisfaction</span>
            <div className='flex flex-row flex-wrap gap-[25px] w-full max-w-[1200px] mt-[50px]'>
            <div className='flex flex-col bg-[#F6FBFF] h-[265px] shrink grow flex-[60%] rounded-[20px] whiteBlockShadow p-[20px]'>aaaaaaaaa</div><div className='flex flex-col bg-[#F6FBFF] h-[265px] shrink grow flex-[30%] rounded-[20px] whiteBlockShadow p-[20px]'>bbbbbbbbb</div>
            <div className='flex flex-col bg-[#F6FBFF] h-[265px] shrink grow flex-[30%] rounded-[20px] whiteBlockShadow p-[20px]'>aaaaaaaaa</div><div className='flex flex-col bg-[#F6FBFF] h-[265px] shrink grow flex-[60%] rounded-[20px] whiteBlockShadow p-[20px]'>bbbbbbbbb</div>
            </div>
