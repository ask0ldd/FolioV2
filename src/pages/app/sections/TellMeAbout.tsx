...
function TellMeAbout(){
    return(
        <section className='flex flex-col w-full items-center overflow-hidden bg-[#D8DFE5] px-[18px] md:px-[40px] xl:px-[80px] py-[75px] md:py-[100px]'>

            <div className="w-[85px] h-[85px] p-[10px] handshakeIconContainer bouncingIcon rounded-full">
            ...
            <h2 className='dm-sans text-[36px] leading-[3rem] md:leading-[4.25rem] text-center md:text-[44px] xl:text-[56px] mt-[20px] md:mt-[28px] max-w-[800px]'>Tell Me About Your Next Creative Project</h2>

            <span className='mt-[18px] max-w-[600px] text-center translate-x-[0px] opacity-100 heroTextTransition delay2s'>
