...
export default function Process(){
    return(
        <section className='flex flex-col w-full items-center py-[100px]'>
            ...
            <h2 className='dm-sans text-[56px] mt-[12px]'>Precision vs Basic</h2>
            <span className='mt-[20px]'>Precision-driven design and animations, surpassing static and unengaging layouts.</span>
            <div className='flex flex-row flex-wrap gap-[25px] w-full max-w-[900px] mt-[40px]'>
                <div className="flex flex-col flex-[40%] shrink grow bg-[#F6FBFF] whiteBlockShadow p-[20px] rounded-[20px]">Step1</div>
                <div className="flex flex-col flex-[40%] shrink grow bg-[#F6FBFF] whiteBlockShadow p-[20px] rounded-[20px]">Step2</div>
                <div className="flex flex-col flex-[40%] shrink grow bg-[#F6FBFF] whiteBlockShadow p-[20px] rounded-[20px]">Step3</div>
                <div className="flex flex-col flex-[40%] shrink grow bg-[#F6FBFF] whiteBlockShadow p-[20px] rounded-[20px]">Step4</div>
            </div>
        </section>
    )
}